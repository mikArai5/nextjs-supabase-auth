        ...
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="mb-5">
                    ...
                    <input
                        type="text"
                        className="border rounded-md w-full py-2 px-3 focus:outline-none focus:borders-sky-500"
                ...
                {/* メッセージ */}
                {message && <div className="my-5 text-center text-sm text-red-500 mb-5">{message}</div>}
